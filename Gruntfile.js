  ...
  grunt.initConfig({
    ...
    connect: {
        options: {
            ...
            hostname: 'localhost',
            livereload: 35729,
            //configure finaract core url
            open:'http://<%= connect.options.hostname %>:<%= connect.options.port %>?baseApiUrl=https://localhost:8443/fineract-provider&tenantIdentifier=default'
        },
        livereload: {
            options: {
                base: [
